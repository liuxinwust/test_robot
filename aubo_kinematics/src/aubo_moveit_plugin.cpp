                                     ...
                                     double search_discretization)
{
  ...
  aubo_link_names_.push_back(arm_prefix_ + "base_Link");       // 0
  aubo_link_names_.push_back(arm_prefix_ + "shoulder_Link");   // 1
  aubo_link_names_.push_back(arm_prefix_ + "upperArm_Link");  // 2
  aubo_link_names_.push_back(arm_prefix_ + "foreArm_Link");    // 3
  aubo_link_names_.push_back(arm_prefix_ + "wrist1_Link");    // 4
  aubo_link_names_.push_back(arm_prefix_ + "wrist2_Link");    // 5
  aubo_link_names_.push_back(arm_prefix_ + "wrist3_Link");    // 6
  aubo_link_names_.push_back(arm_prefix_ + "ee_Link");    // 7
